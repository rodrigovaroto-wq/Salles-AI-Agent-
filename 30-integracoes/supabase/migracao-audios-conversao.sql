...
-- ---------------------------------------------------------------------------
-- Os 15 áudios. Bucket público `entrega`, com uma pasta `entrega` dentro dele
-- (foi assim que o upload ficou) — daí o `/entrega/entrega/` nas URLs.
-- Conferido em 30/07: os 15 respondem HTTP 200 com content-type audio/ogg.
--
-- As URLs já apontam para o projeto rmvmqmcfcjmcjtonewgi e para os arquivos
-- `.ogg` (opus), que o WhatsApp entrega como mensagem de voz. Rode direto.
--
...
insert into audios_agente (chave, url, descricao, quando_usar, ordem) values
  ...
  ('saudacao',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-01-saudacao.ogg',
  ...
  ('aquecimento',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-02-aquecimento.ogg',
  ...
  ('transicao_oracao',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-08-transicao-oracao.ogg',
  ...
  ('recebe_agora',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-13-recebe-agora.ogg',
  ...
  ('explicacao_audio_opcional',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-10-explicacao-audio-opcional.ogg',
  ...
  ('antes_do_valor',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-05-antes-do-valor.ogg',
  ...
  ('contribuicao',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-15-contribuicao.ogg',
  ...
  ('acolhimento_preco',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-11-acolhimento-preco.ogg',
  ...
  ('duvida',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-07-duvida.ogg',
  ...
  ('antes_de_decidir',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-14-antes-de-decidir.ogg',
  ...
  ('acolhimento_dor',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-04-acolhimento-dor.ogg',
  ...
  ('ajuda_primeira_compra',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-12-ajuda-primeira-compra.ogg',
  ...
  ('orientacao_cadastro',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-09-orientacao-cadastro.ogg',
  ...
  ('como_pagar_pix',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-06-como-pagar-pix.ogg',
  ...
  ('pos_pagamento',
   'https://rmvmqmcfcjmcjtonewgi.supabase.co/storage/v1/object/public/entrega/entrega/audios-conversao/audio-03-pos-pagamento.ogg',
