...
--
-- ⚠️ Ajuste <PROJETO> para o ref do seu Supabase antes de rodar.
--
...
insert into audios_agente (chave, url, descricao, quando_usar, ordem) values
  ...
  ('saudacao',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-01-saudacao.mp3',
  ...
  ('aquecimento',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-02-aquecimento.mp3',
  ...
  ('transicao_oracao',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-08-transicao-oracao.mp3',
  ...
  ('recebe_agora',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-13-recebe-agora.mp3',
  ...
  ('explicacao_audio_opcional',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-10-explicacao-audio-opcional.mp3',
  ...
  ('antes_do_valor',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-05-antes-do-valor.mp3',
  ...
  ('contribuicao',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-15-contribuicao.mp3',
  ...
  ('acolhimento_preco',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-11-acolhimento-preco.mp3',
  ...
  ('duvida',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-07-duvida.mp3',
  ...
  ('antes_de_decidir',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-14-antes-de-decidir.mp3',
  ...
  ('acolhimento_dor',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-04-acolhimento-dor.mp3',
  ...
  ('ajuda_primeira_compra',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-12-ajuda-primeira-compra.mp3',
  ...
  ('orientacao_cadastro',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-09-orientacao-cadastro.mp3',
  ...
  ('como_pagar_pix',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-06-como-pagar-pix.mp3',
  ...
  ('pos_pagamento',
   'https://<PROJETO>.supabase.co/storage/v1/object/public/entrega/audios-conversao/audio-03-pos-pagamento.mp3',
...
-- Conferência: nenhuma URL pode ficar com <PROJETO>
select chave,
       case when url like '%<PROJETO>%' then '❌ URL NAO AJUSTADA' else '✅ ok' end as url_ok,
       descricao
from audios_agente order by ordem;
